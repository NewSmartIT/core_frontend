...
include('bower_components/core_frontend/js/twitter/jquery.tweet.js'); // Twitter widget */
include('bower_components/core_frontend/js/tinynav.min.js'); // Tiny nav
	...
	function quickViewModal(el){
		...
		elements.click(function(e){
			...
			$('#quick-view-content .quick-view-container').load(target+' #product-single', function(){
				...
				/* Rating Box */
				$('#quick-view-modal .rating.readonly-rating').raty({ readOnly: true, path:'images',score: function() {
					return $(this).attr('data-score');
				}});
				$('#quick-view-modal .rating.rate').raty({ path:'images',score: function() {
					return $(this).attr('data-score');
				}});
